...
folder `angular-quill-snapshots`, which then contains an additional folder called `sandbox`.
...
- **snaphot.sh**: Run this script to generate the `angular-quill-snapshots` folder, containing
